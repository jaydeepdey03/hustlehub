...
const Navbar = () => {
  ...
  useEffect(() => {
    SDK.get()
      .then((res: AuthUser) => {
        ...
        DB.getDocument("646cfa393629aedbd58f", "646edbd8de898ccf87c5", res.$id)
          .then((result) => {
            setRole(result.role);
          })
  ...
  return (
    <>
      <Modal
        onClose={startupDisclosure.onClose}
        size={"xl"}
        isOpen={startupDisclosure.isOpen}
      >
        <ModalOverlay />
        <ModalContent>
        ...
        <ModalContent>
          ...
          <Formik
            ...
            validationSchema={Yup.object({
              ...
              noOfMembers: Yup.number().required(
                  ...
                  <Box>
                    <Menu>
                      ...
                      <MenuList>
                        <MenuItem
                          as="button"
                          onClick={startupDisclosure.onOpen}
                        >
                          Create Startup Idea
                        </MenuItem>
                        <MenuItem
