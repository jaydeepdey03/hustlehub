...
const Startupcard = (props: StartupcardProps) => {
  ...
  return (
    <>
      <Box key={index}>
        <Modal
          onClose={learnMoreDisclosure.onClose}
          size={"xl"}
          isOpen={learnMoreDisclosure.isOpen}
          isCentered
          ...
          <ModalContent>
            ...
            <ModalBody>
              <Stack spacing={4}>
                  ...
                  <Box>
                    ...
                    <HStack>
                      ...
                      >
                        {/* put user name */}
                        {document.founder}{" "}
                        {document.founder === details.$id && "(You)"}
                      </Text>
                    </HStack>
                  </Box>
                ...
                <Stack spacing={"5"}>
                  <Text m="1" fontWeight={"semibold"} fontSize={"md"}>
                    Milestones
                  </Text>
                  <Milestones
                    milestoneArray={document.milestones}
                    startup={document}
                    user={details}
                  />
                </Stack>
        ...
        >
          <Image
            ...
            alt="Caffe Latte"
            fallback={<Skeleton w={{ base: "100%", xl: "300px" }} />}
          />
          ...
          <Stack w="full">
            ...
            >
              <Box>
                <Heading mb="3" size="sm" fontWeight={"semibold"}>
                  Founder{" "}
                </Heading>
                <Profilecard
                  userId={document.founder}
                  created={false}
                  details={true}
                />
              </Box>
            ...
            <Formik
              ...
              validationSchema={Yup.object({
                ...
                milestone: Yup.array().of(
                  Yup.string().required("Milestone is required"),
                ),
              })}
