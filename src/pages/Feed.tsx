...
const Feed = () => {
  ...
  const [startupCollection, setStartupCollection] = useState(
    [] as StartupInterface[],
  );
  const [hackathonCollection, setHackathonCollection] = useState(
          ...
          >
            ...
            <TabPanels>
              ...
              <TabPanel>
                ...
                {hackathonCollection &&
                  hackathonCollection.map(
                    (document: HackathonInterface, index: number) => {
